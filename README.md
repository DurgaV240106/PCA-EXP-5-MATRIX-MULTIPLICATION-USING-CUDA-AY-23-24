...
## OUTPUT:
![image](https://github.com/user-attachments/assets/c17c8c98-d4c9-4039-810f-f4616a0a0134)
...
```
##  OUTPUT:
![image](https://github.com/user-attachments/assets/88e4758f-1c95-443f-b7f4-86ad5167cbdd)

```
!nvprof ./matmul
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/f3b2370a-fb46-4645-9f07-ba4be64cc4d4)

```
!nvprof --print-gpu-trace ./matmul
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/2a2bfee8-8b47-4f52-9674-b9e0aa67dd73)
